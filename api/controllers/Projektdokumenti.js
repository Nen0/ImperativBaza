...
function fileUpload(name, file, cb) {
    var path = 'C:\\Users\\Ivan Šimić\\Desktop\\imperativ\\BackendREST\\documents\\projekti\\' + name + '';
    ...
    fs.readFile(path, function(err, data) {
        if (err) {
            ...
            path = 'C:\\Users\\Ivan Šimić\\Desktop\\imperativ\\BackendREST\\documents\\projekti\\' + newName + '';
            name = newName
...
function downloadDoc(req, res) {
    ...
    var img = fs.readFileSync('C:\\Users\\Ivan Šimić\\Desktop\\imperativ\\BackendREST\\documents\\projekti\\' + filename + '');
