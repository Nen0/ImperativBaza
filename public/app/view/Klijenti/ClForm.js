    ...
    initComponent: function(config) {       
        this.items = [{
            ...
            items: [{
                ...
                minLength: 11,
                maxLength: 11,
                maxLengthText:'OIB treba imati točno 11 znamenki',
                msgTarget:'under',  
                minLengthText:'OIB treba imati točno 11 znamenki',
                name: 'oib',
                required: true
            ...
            items: [{
                ...
                name: 'postanskibroj',
                maxLength:6,
                maxLengthText:'Poštanski broj može imati maksimalno 6 znamenki',
                hideTrigger: true
            }, {
                xtype: 'textfield',
                fieldLabel: 'Faks',
            ...
            maxLength:7,
            maxLengthText:'Maksimalan broj stanovnika koji možete unijeti je do 10 000 000',
            msgTarget:'under',
